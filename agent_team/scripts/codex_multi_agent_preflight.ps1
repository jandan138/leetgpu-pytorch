...
Write-Host "   Windows: powershell -ExecutionPolicy Bypass -File agent_team/scripts/bootstrap_agents.ps1"
Write-Host "2) Linux/macOS: bash agent_team/scripts/init_run.sh <run_id>"
Write-Host "   Windows: powershell -ExecutionPolicy Bypass -File agent_team/scripts/init_run.ps1 -RunId <run_id>"
Write-Host "3) Linux/macOS: bash agent_team/scripts/setup_run_worktrees.sh <run_id>"
Write-Host "   Windows: powershell -ExecutionPolicy Bypass -File agent_team/scripts/setup_run_worktrees.ps1 -RunId <run_id>"
...
Write-Host "   powershell -ExecutionPolicy Bypass -File agent_team/scripts/monitor_subagents.ps1 -RunId <run_id> -IntervalMin 10 -StuckMin 45"
