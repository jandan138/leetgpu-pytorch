...
- Role: Data and pipeline maintainer
- Permissions:
  - can_edit_code: true
  - can_run_tests: true
...
## Mission
- Maintain trustworthy data pipelines and schema compatibility.
...
## Outputs
- Agent log updates under runs/<run_id>/logs/data-engineer.md
